...
app.use("/api/users", userRoutes);         // → /api/users, /api/users/me, etc.
app.use("/api/manga", mangaRoutes);        // → /api/manga/chapters/images etc.
app.use("/api/ratings", ratingRoutes);     // → /api/ratings/reviews/add
app.use("/api/reviews", reviewRoutes);     // → /api/reviews, /api/reviews/:book_id
